...
public class dos2 extends AppCompatActivity {
    ImageView pel;
    Button uno,dos,tres,cuatro;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cpelota);
            ...
            public void run() {
                ...
                if (d<=300) {
                    ...
                    if (control==1) {
                        ...
                        Intent intent = new Intent(dos2.this, fin.class);
    ...
    public void muevepelotaida3(int a, int b) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (e==-100) {
                    Intent intent = new Intent(dos2.this, tres2.class);
                    startActivity(intent);
                    finish();
                }
            }
